              ...
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <div className="flex items-center">
                  <a
                    ...
                    className="dark:text-body-color-dark mr-6 text-body-color duration-300 hover:text-[#45988e] dark:hover:text-[#45988e]"
                  >
                    <svg
                      width="9"
                      height="18"
                  ...
                  <a
                    href="/"
                    aria-label="social-link"
                    className="dark:text-body-color-dark text-body-color duration-300 hover:text-[#45988e] dark:hover:text-[#45988e]"
                  >
                    <svg
                      width="17"
                      height="16"
              ...
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  ...
                  <li>
                    <a
                      href="/about"
                      className="dark:text-body-color-dark mb-4 inline-block text-base text-body-color duration-300 hover:text-[#45988e] dark:hover:text-primary"
                    >
                      About
                    </a>
                  </li>
