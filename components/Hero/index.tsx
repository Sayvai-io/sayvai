...
const Hero = () => {
  return (
    <>
      <section
        id="home"
        className="dark:bg-gray-dark relative z-10 overflow-hidden bg-white pb-16 pt-[0px] md:pb-[120px] md:pt-[10px] xl:pb-[160px] xl:pt-[30px] 2xl:pb-[200px] 2xl:pt-[40px]"
      >
          ...
          <div className="flex-1 flex items-center justify-center md:justify-start">
            ...
            >
              <div className="wow fadeInUp text-center md:text-left" data-wow-delay=".2s">
                <h1 className="mb-1 text-3xl font-bold leading-tight text-[#45988e] dark:text-white sm:text-7xl sm:leading-tight md:text-6xl md:leading-tight">
                  AI in Your Business!
                </h1>
                <p className="dark:text-body-color-dark mb-4 text-base !leading-relaxed text-body-color sm:text-lg md:text-1xl">
